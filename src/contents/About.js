  ...
  render() {
    return (
      ...
      <p>I am a software developer and tech enthusiast, having recently graduated 
        from the intensive Makers Academy web development course (I've blogged about 
        the experience <a href="https://blog.makersacademy.com/tips-to-max-your-learning-5e363517acfb">here</a>. 
